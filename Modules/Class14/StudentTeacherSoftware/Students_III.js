...
class Students extends Members {
    ...
    showMyDetails() {
        console.log(`\nStudent details:\nId: ${this.#student.Id}`);
        super.showMyDetails();
        console.log(`Course name: ${this.#student.courseDetails.courseName}\nCourse Length: ${this.#student.courseDetails.courseLength} month(s)\nBalance: $${this.#student.sBalance}\n`);
    ...
    */
    ...
    changeCourse(newCourse){
        if (this.isCourseNameValid(newCourse) && this.#student.courseDetails.courseName == newCourse){
